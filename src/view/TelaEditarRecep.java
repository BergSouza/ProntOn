...
public class TelaEditarRecep extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Editar Recepcionista");
        ...
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 260, 70, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        recepController.editarRecep(CampoNome.getText(), CampoCPF.getText(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaEditarRecep.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
